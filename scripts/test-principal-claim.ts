...
assert.ok(claimFn.includes('reactivateDeskToken'))
assert.ok(claimFn.includes('principal_reactivated'))
assert.ok(claimFn.includes(".select('id, role, conference_id')"))
assert.ok(claimFn.includes("rotated.role !== 'principal'"))
